...
class CIFAR10ShardDescriptor(ShardDescriptor):
    ...
    def _download_and_prepare_dataset(self, rank: int, worldsize: int) -> Tuple[tf.data.Dataset]:
        """
    ...
    def dataset_description(self) -> str:
        ...
        return (f'CIFAR10 dataset, Train/Test Shard Segment {self.train_segment}/{self.test_segment}, rank/world {self.rank}/{self.worldsize}.'
                f'\nn_samples [Train/Valid]: [{n_train}/{n_test}]')