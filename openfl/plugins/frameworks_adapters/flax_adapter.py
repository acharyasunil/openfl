...
from openfl.plugins.frameworks_adapters.timeit import fedtiming
from openfl.utilities.config import getconfig
...
class FrameworkAdapterPlugin(FrameworkAdapterPluginInterface):
    ...
    @staticmethod
    @fedtiming(timeout=config.fw_get_tensor)
    ...
    @staticmethod
    @fedtiming(timeout=config.fw_set_tensor)
